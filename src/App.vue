...
function itemDisplay(id) {
  products.forEach((goods) => {
    if (goods.id === id) showData.value = goods;
  });
}
</script>
    ...
    <div class="container">
      <div class="row py-3">
          ...
          <table class="table table-hover mt-4">
            ...
            <tbody>
              <tr v-for="item in products" :key="item.id">
                ...
                <td width="120">
                  <button
                    @click.prevent="itemDisplay(item.id)"
                    type="button"
        ...
        <div class="col-md-6">
          ...
          <template v-if="showData.id">
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <div class="d-flex">
                  <p class="card-text me-2">每{{ showData.unit }}</p>
                  <p class="card-text text-secondary">
                    <del>{{ showData.origin_price }}</del>
                  </p>
                  元 / {{ showData.price }}元
                </div>
              </div>
          ...
          <p v-if="!showData.id" class="text-secondary">請選擇一個商品查看</p>
        </div>
      </div>
    </div>
  </main>
